...
class ImportProcessPayloadDataDeleter implements ImportProcessPayloadDataDeleterInterface
{
    /**
     ...
     * @return void
     */
    public function deletePayloadData(ImportProcessDataImportConfigurationCollectionTransfer $dataImportConfigurationCollectionTransfer): void
    {
